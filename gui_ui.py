...
class Ui_Main(object):
    def setupUi(self, Main):
        ...
        icon6 = QIcon()
        icon6.addFile(u"icons/menu/Save.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_SaveGraph.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u"icons/menu/Load.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_LoadGraph.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/Errors/errors/current history.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_Errors_InstanceHistory_basic.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/Errors/errors/all history.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_Errors_AllHistory_basic.setIcon(icon9)
        ...
        self.btn_Errors_Refresh_basic.setIcon(icon10)
        ...
        self.btn_Errors_InstanceHistory_admin.setIcon(icon8)
        ...
        self.btn_Errors_AllHistory_admin.setIcon(icon9)
        ...
        self.btn_Errors_Refresh_admin.setIcon(icon10)
