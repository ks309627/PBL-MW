...
class MeasureProcess:
    ...
    def __init__(self, gui:Ui_Main, settings:Settings):
        ...
        try:
            ...
            self.logger.log_error("Start Up: Nie można połączyć się z mikrokontrolerem ESP. Proszę sprawdzić kabel oraz stan urządzenia. Odłączenie i ponowne podłączenie kabla może być wymagane.")
